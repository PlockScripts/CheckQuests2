        ...
        if World1 then
           ...
           if (MyLevel >= 1500 and MyLevel <= 1524) or SelectMonster == "Pirate Millionaire" then
            ...
            elseif (MyLevel >= 2525 and MyLevel <= 2550) or SelectMonster == "Isle Champion" then
             ...
             elseif (MyLevel >= 2575 and MyLevel < 2600) or SelectMonster == "Skull Slayer" then
                Mon = "Skull Slayer"
                LevelQuest = 2
                NameQuest = "TikiQuest3"
            ...
            elseif (MyLevel >= 2600 and MyLevel < 2625) or SelectMonster == "Tiki Warrior" then
                Mon = "Tiki Warrior"
                LevelQuest = 1
                NameQuest = "TikiQuest3"
                NameMon = "Tiki Warrior"
                CFrameQuest = CFrame.new(-16450.9, 87.9, 1605.3)
                CFrameMon = CFrame.new(-16570.4, 90.2, 1505.6)
            elseif (MyLevel >= 2625 and MyLevel < 2650) or SelectMonster == "Tiki Guard" then
                Mon = "Tiki Guard"
                LevelQuest = 2
                NameQuest = "TikiQuest3"
                NameMon = "Tiki Guard"
                CFrameQuest = CFrame.new(-16450.9, 87.9, 1605.3)
                CFrameMon = CFrame.new(-16725.6, 92.4, 1402.1)
           elseif (MyLevel >= 2650 and MyLevel < 2675) or SelectMonster == "Shark Warrior" then
                Mon = "Shark Warrior"
                LevelQuest = 1
                NameQuest = "ForgottenQuest"
                NameMon = "Shark Warrior"
                CFrameQuest = CFrame.new(5814.21, 68.12, -6891.76)
                CFrameMon = CFrame.new(6123.55, 61.43, -6930.11)
          elseif (MyLevel >= 2675 and MyLevel < 2700) or SelectMonster == "Shark Boss" then
               Mon = "Shark Boss"
               LevelQuest = 2
               NameQuest = "ForgottenQuest"
               NameMon = "Shark Boss"
               CFrameQuest = CFrame.new(5814.21, 68.12, -6891.76)
               CFrameMon = CFrame.new(6241.17, 62.33, -7105.42)
         elseif (MyLevel >= 2700 and MyLevel < 2725) or SelectMonster == "Fish Warrior" then
               Mon = "Fish Warrior"
               LevelQuest = 1
               NameQuest = "FishmanQuest"
               NameMon = "Fish Warrior"
              CFrameQuest = CFrame.new(6125.35, 52.48, -8025.91)
              CFrameMon = CFrame.new(6350.12, 48.72, -8201.44)
        elseif (MyLevel >= 2725 and MyLevel < 2750) or SelectMonster == "Fish King" then
              Mon = "Fish King"
              LevelQuest = 2
              NameQuest = "FishmanQuest"
              NameMon = "Fish King"
             CFrameQuest = CFrame.new(6125.35, 52.48, -8025.91)
             CFrameMon = CFrame.new(6502.66, 65.71, -8325.82)
        elseif (MyLevel >= 2750 and MyLevel < 2775) or SelectMonster == "Sea Soldier" then
             Mon = "Sea Soldier"
             LevelQuest = 1
             NameQuest = "SeaQuest"
             NameMon = "Sea Soldier"
             CFrameQuest = CFrame.new(5701.72, 53.22, -8891.65)
             CFrameMon = CFrame.new(5852.41, 49.58, -9050.17)
        elseif (MyLevel >= 2775) or SelectMonster == "Sea King" then
             Mon = "Sea King"
             LevelQuest = 2
             NameQuest = "SeaQuest"
             NameMon = "Sea King"
             CFrameQuest = CFrame.new(5701.72, 53.22, -8891.65)
             CFrameMon = CFrame.new(5980.88, 62.12, -9205.44)
            end
        end
    end
